$(document).ready(function () {
    ...
    x.forEach(function (time, index) {
        ...
        newTextInput.attr("id", "data-text" + index);
    ...
    $("button").on("click", function (event) {
        ...
        var textInput = $(this).siblings("input").attr("id");
    ...
    function fillTimeSlots(){
        ...
        for(var i = 0; i < 9; i++){
            ...
            var text = localStorage.getItem(`data-text${i}`);
            console.log('text', `#data-text${i}`)

        
                $(`#data-text${i}`).val(text);
